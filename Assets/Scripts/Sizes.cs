    ...
    private IEnumerator CompleteTaskWithDelay(float delay)
{
    ...
    Debug.Log("Task completed, loading Level4.");
    
    // Load Level4 from the build
...
public class StarInteract : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (var star in stars)
        {
            ...
            if (distance < 1f && star.name.ToLower().Contains(promptedSize))
            {
                ...
                // ✅ Awarding 100 points for choosing the correct star
    ...
    private IEnumerator CompleteTaskWithDelay(float delay)
    {
        ...
        Debug.Log("✅ Task completed, loading Level 4.");
