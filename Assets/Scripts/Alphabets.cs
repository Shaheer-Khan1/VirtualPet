...
public class Alphabets : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ShowCanvas("What letter does the colour of the sky start with?");
    }
    ...
    void Update()
    {
        ...
        foreach (var food in foods)
        {
            ...
            if (distance < 5f) // Food becomes visible when the player is near
            {
                ...
                ShowCanvas("Choose the the starting letter of colour of the sky!");
            ...
            if (distance < 1f && food == healthyFood)
            {
                ...
                ShowCanvas("Good Job! You chose the correct letter!");

                // ✅ Awarding 150 points for choosing the healthy food
                if (ScoreManager.Instance != null)
                {
                    ScoreManager.Instance.AddScore(150);
                    Debug.Log("✅ 150 points awarded! Total Score: " + ScoreManager.Instance.score);
                }
                ...
                // Add a wait before hiding the prompt and deactivating the game object
